      ...
      html: `
        <div style="font-family:Arial,sans-serif;max-width:560px;margin:0 auto;padding:28px;background:#f8fafc;">
          <div style="background:#fff;border:1px solid #e2e8f0;border-radius:16px;overflow:hidden;">
            <div style="background:#1d4ed8;color:#fff;padding:22px 26px;">
            ...
            <div style="padding:26px;">
              ...
              <div style="background:#f8fafc;border:1px solid #e8edf5;border-radius:12px;padding:18px;margin-bottom:22px;">
                ...
                <p style="font-size:22px;font-weight:800;color:#1d4ed8;margin:0;">${price}</p>
              </div>
              <a href="${listingUrl}" style="display:inline-block;background:#1d4ed8;color:#fff;text-decoration:none;font-weight:700;border-radius:10px;padding:12px 22px;">Katso ilmoitus</a>
            </div>
          </div>
        </div>
      `
