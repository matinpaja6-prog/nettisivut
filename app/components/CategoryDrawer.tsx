...
/* ── component ──────────────────────────────────────── */
const MOPED_CC_OPTIONS = ["50", "65", "70", "72", "75", "77", "80", "85", "86", "88", "90", "94", "100", "110"];
...
export const CC_OPTIONS: Record<string, string[]> = {
  ...
  "Mönkijä":      Array.from({ length: 24 }, (_, index) => String((index + 1) * 50)),
  Motocross:      ["50", "65", "85", "125", "150", "250", "300", "350", "450", "500"],
  Mopot:          MOPED_CC_OPTIONS,
  Mopo:           MOPED_CC_OPTIONS,
};
