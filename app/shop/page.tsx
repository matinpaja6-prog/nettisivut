...
export default function ShopPage() {
  ...
  }[locale] ?? { h1: "", desc: "", loginPrompt: "", loginLink: t.login, loading: "...", notEnoughPoints: (c: number) => `${c}`, buyFailed: (e: string) => e, buySuccess: (title: string, days: number) => `${title} ${days}d`, pointsAvailable: "", listingSlots: "", slotBase: () => "", slotTitle: "", slotValidity: "", inUseNow: "", slotNote: "", pointsSuffix: "p", validFor: () => "", buying: "...", buyWithPoints: "", noPoints: "", activePurchases: "", expiresAt: (d: string) => d, cashTitle: "", cashDesc: "", addPaypalId: "", securityNote: "", earnMore: "", loginRequired: "", paypalFail: "", paypalOrderFail: "", paypalNoOrderId: "", paypalSessionExpired: "", paypalCaptureFail: "", paypalSuccess: (p: string) => p, paypalLoadFail: "" };
