...
import { companyIdentityCopy } from "@/lib/company-identity";
...
const termsCopy: Record<Locale, {
  ...
  sections: Array<{ title: string; body: string[]; bullets?: string[] }>;
    ...
    back: "Takaisin", eyebrow: "Palvelun ehdot", title: "Käyttöehdot", updated: "Päivitetty 30.8.2026", privacy: "Tietosuojaseloste", summaryLabel: "Käyttöehtojen tiivistelmä",
    summary: [
    ...
    sections: [
      ...
      { title: "7. Maskinesin vastuu ja palvelun saatavuus", body: ["Maskines vastaa omasta alustapalvelustaan ja sen toiminnasta sovellettavan pakottavan lain mukaisesti. Pyrimme pitämään palvelun toimivana ja turvallisena, mutta emme takaa keskeytyksetöntä tai virheetöntä saatavuutta.", "Maskines ei alustapalvelun tarjoajana vastaa muiden myyjien tuotteiden laadusta, kunnosta, sopivuudesta tai virheestä eikä myyjän toimitus-, palautus-, reklamaatio- tai hyvitysvelvollisuuden täyttämisestä. Maskines ei myöskään takaa käyttäjän henkilöllisyyttä, ilmoituksen tietoja tai kaupan toteutumista.", "Mikään näissä ehdoissa ei rajoita vastuuta tai käyttäjän oikeuksia siltä osin kuin niitä ei pakottavan lain mukaan voida rajoittaa."] },
  ...
  en: {
    back: "Back", eyebrow: "Service terms", title: "Terms of Use", updated: "Updated 30 August 2026", privacy: "Privacy Notice", summaryLabel: "Terms summary",
    summary: [
    ...
    sections: [
      ...
      { title: "4. Trading and seller responsibility", body: ["Maskines provides the marketplace and may technically facilitate payment. The sales contract is between the buyer and the seller identified in the listing.", "The seller is responsible for the accuracy, condition, safety and legality of the product and for delivery or handover after payment. The seller is also responsible for returns, complaints, price reductions, cancellation, refunds and other statutory or agreed seller obligations.", "Claims concerning a defective product or a refused return must be addressed directly to the seller. Maskines may provide technical support but does not assume the seller's obligations.", "Mandatory consumer law applies to sales between a business seller and a consumer. Sales between private individuals generally do not carry a statutory consumer cancellation right. Check the seller's status, product details and return terms before payment."] },
      { title: "5. Payments and service fee", body: ["An online payment to a business seller is processed directly on the business's own Stripe account. The business is the payment recipient and is responsible for Stripe processing fees, refunds, disputes and its Stripe account balance.", "Maskines retains a 1% service fee from each successfully processed business sale. The fee compensates the platform service delivered when the payment is processed and is not returned to the business if it later cancels the sale or refunds the buyer, unless mandatory law requires otherwise.", "Other paid features such as listing slots, highlights and visibility boosts are shown before payment confirmation."] },
      ...
      { title: "7. Maskines liability and availability", body: ["Maskines is responsible for its own platform service and operations as required by mandatory applicable law. We aim to keep the service functional and secure but do not guarantee uninterrupted or error-free availability.", "As a platform provider, Maskines is not responsible for other sellers' product quality, condition, compatibility or defects, or for the seller's performance of delivery, return, complaint or refund obligations. Maskines does not guarantee a user's identity, listing information or completion of a sale.", "Nothing in these terms limits liability or user rights where mandatory law does not permit such limitation."] },
  ...
  sv: {
    back: "Tillbaka", eyebrow: "Tjänstevillkor", title: "Användarvillkor", updated: "Uppdaterad 30.8.2026", privacy: "Integritetspolicy", summaryLabel: "Sammanfattning",
    ...
    sections: [
      ...
      { title: "4. Handel", body: ["Maskines tillhandahåller marknadsplatsen och kan tekniskt förmedla betalningen. Köpeavtalet ingås med säljaren som anges i annonsen. Säljaren ansvarar för produktuppgifter, skick, leverans, returer, reklamationer och återbetalningar. Tvingande konsumentlagstiftning gäller oförändrad."] },
      { title: "5. Betalningar och serviceavgift", body: ["En nätbetalning till en företagssäljare behandlas direkt på företagets eget Stripe-konto. Företaget ansvarar för Stripes behandlingsavgifter, återbetalningar, tvister och saldot på sitt Stripe-konto.", "Maskines behåller en serviceavgift på 1 % från varje genomförd företagsbetalning. Avgiften återbetalas inte till företaget om företaget senare avbryter köpet eller återbetalar köparen, om inte tvingande lag kräver annat."] },
      ...
      { title: "7. Ansvar", body: ["Maskines ansvarar för sin egen plattformstjänst enligt tvingande lag, men i rollen som plattformsleverantör inte för andra säljares produkter eller säljarens leverans-, retur-, reklamations- eller återbetalningsskyldigheter. Ingenting i villkoren begränsar rättigheter eller ansvar som inte får begränsas enligt tvingande lag."] },
  ...
  no: {
    back: "Tilbake", eyebrow: "Vilkår", title: "Brukervilkår", updated: "Oppdatert 30.8.2026", privacy: "Personvernerklæring", summaryLabel: "Sammendrag",
    ...
    sections: [
      ...
      { title: "4. Handel", body: ["Maskines tilbyr markedsplassen og kan teknisk formidle betalingen. Kjøpsavtalen inngås med selgeren som er oppgitt i annonsen. Selgeren er ansvarlig for produktopplysninger, tilstand, levering, returer, reklamasjoner og refusjoner. Ufravikelig forbrukerlovgivning gjelder uendret."] },
      { title: "5. Betalinger og tjenestegebyr", body: ["En nettbetaling til en bedriftsselger behandles direkte på bedriftens egen Stripe-konto. Bedriften er ansvarlig for Stripes behandlingsgebyrer, refusjoner, tvister og saldoen på sin Stripe-konto.", "Maskines beholder et tjenestegebyr på 1 % fra hver gjennomført bedriftsbetaling. Gebyret refunderes ikke til bedriften dersom bedriften senere avbryter handelen eller refunderer kjøperen, med mindre ufravikelig lov krever noe annet."] },
      ...
      { title: "7. Ansvar", body: ["Maskines er ansvarlig for sin egen plattformstjeneste etter ufravikelig lov, men i rollen som plattformleverandør ikke for andre selgeres produkter eller selgerens leverings-, retur-, reklamasjons- eller refusjonsforpliktelser. Ingenting i vilkårene begrenser rettigheter eller ansvar som ikke kan begrenses etter ufravikelig lov."] },
          ...
          {copy.sections.map((section) => (
            <details key={section.title} className="terms-section legal-accordion-item">
              ...
              <div className="legal-accordion-body">
                ...
                {section.title.startsWith("4.") && <p>{companyIdentityCopy[locale].sellerRole}</p>}
