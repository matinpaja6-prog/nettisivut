...
> = {
  ...
  scooter: {
    Aprilia: ["Amico", "Habana", "Mojito", "Rally", "Scarabeo", "SR"],
    Benelli: ["49X", "LX"],
    Honda: ["Bali EX", "Dio", "NSC 50", "SFX", "SH 50", "Vision 50", "X8R-X", "X8RS", "Zoomer"],
    Keeway: ["Agora", "F-act", "FLASH", "Focus", "Hacker", "Hurricane", "Kite", "Leone", "Matrix", "RX6", "RX8", "RY6", "Swan", "Urban Blade", "X-Blade", "Zahara"],
    Kymco: ["Agility", "Cobra", "DJ", "Ionex I-One", "Like 50", "Movie", "People 50", "Super 8 50", "ZX"],
    Piaggio: ["1", "Fly 50", "Free", "Liberty 50", "NRG", "Sfera", "Typhoon 50", "ZIP"],
    Suzuki: ["AY 50", "Estilete", "Katana 50", "Love"],
    SYM: ["Allo 50", "Fiddle II 50", "Jet4 50", "Jet4 50 R", "Jet BasiX", "Jet EuroX 50", "Jet SportX 50 S", "Jet SportX 50 SR", "Mask", "Orbit 50", "Orbit II 50", "RS 50", "Symphony ST 50"],
    Vespa: ["Elettrica 45", "ET2", "ET4 50", "LX 50", "PK 50", "Primavera 50", "S 50", "Sprint 50"],
    Yamaha: ["Aerox", "Beluga", "BW´S", "Jog", "Neons", "Neos", "Slider"],
